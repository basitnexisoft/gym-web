    ...
    <div className='flex flex-col bg-[#222] w-full md:w-1/3 p-5 rounded-lg'>
      ...
      <div className='flex flex-col items-center mt-5'>
        <div className='flex flex-row items-center'>
          ...
          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Corrupti soluta saepe fuga voluptates reprehenderit eius!</p>
        </div>
        <div className='flex flex-row items-center'>
          <span className='inline-block mr-5'>
            <AiFillCheckCircle size={22} />
          </span>
          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. A officiis voluptatum iste.</p>
        </div>
      </div>
