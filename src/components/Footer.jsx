    ...
    <div className=" bg-[#222] rounded-t-3xl">
      <div className=" flex flex-col md:flex-row justify-between md:px-32 px-5 p-5">
        <div className=" w-full md:w-1/4">
          ...
          <p className=" mt-4">
            Lorem ipsum dolor sit amet consectetur adipisicing elit.kmugt g5dg 7fsvrs grsh
            fyuiu6rbii jhfj cbhfk jugcy gftdjjf jrftj yrhkd gfdjif bfdljhfky.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <div className=" flex flex-row items-center gap-2 mt-4">
            ...
            <p>+92-316-92-070-48</p>
          </div>
          <div className=" flex flex-row items-center gap-2">
            <AiOutlineMail size={20} />
            <p>basit.nexisoft@gmail.com</p>
          </div>
        </div>
      </div>
      <div>
        <p className=" text-center mt-4">
          @copyright developed by   <span className=" text-brightRed"> basit programmers</span> | All
          rights reserved
        </p>
      </div>
    </div>
